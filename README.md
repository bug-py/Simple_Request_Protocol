...
- ## Présentation
#### SRP est une biothèque écrite en C qui implémente un protocole personnalisé basé sur TCP  
...
#### id : sert au client, elle désigne le recours demandé au serveur
#### lenght : est le nombre d'octets que prend le message principal
